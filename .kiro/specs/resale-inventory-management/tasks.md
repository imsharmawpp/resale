...
- [ ] 1. Scaffold the WordPress plugin and build/test infrastructure
  - [ ] 1.1 Create plugin bootstrap and PSR-4 autoloader
  ...
  - [ ] 1.2 Implement the dependency-injection container
  ...
  - [ ] 1.3 Implement activation and deactivation routines
  ...
  - [ ] 1.4 Implement the versioned migration runner and schema migrations
  ...
  - [ ] 1.5 Set up the asset build pipeline with `rims-` prefix scoping
  ...
  - [ ] 1.6 Set up the dual property-based test harness
...
- [ ] 2. Implement domain value objects, enums, and serializers
  - [ ] 2.1 Implement `UnitStatus` enum and the status-to-color map
  ...
  - [ ]* 2.2 Write property test for status-to-color mapping
  ...
  - [ ] 2.3 Implement `PipelineStage` and `ViewMode` enums
  ...
  - [ ] 2.4 Implement the `Money` value object with Indian-convention parsing
    - Store amount in paise; parse `3 Cr` → 30,000,000 and `75 L` → 7,500,000 as exact integers; provide `format()`
    - _Requirements: 14.1_

  - [ ] 2.5 Implement DTOs and `FilterSet`/`SearchCriteria` value objects
  ...
  - [ ] 2.6 Implement the audience-based field-visibility serializer
  ...
  - [ ]* 2.7 Write property test for owner-field redaction
  ...
  - [ ]* 2.8 Write property test for field-complete row/card rendering
  ...
  - [ ]* 2.9 Write property test for REST JSON round-trip
...
- [ ] 3. Implement the repository layer and multi-tenant scoping
  - [ ] 3.1 Implement the base repository with parameterized, tenant-scoped queries
  ...
  - [ ]* 3.2 Write property test for injection-inert database access
  ...
  - [ ]* 3.3 Write property test for tenant data isolation
  ...
  - [ ] 3.4 Implement concrete repositories
  ...
  - [ ] 3.5 Implement the tenant and branding resolver
  ...
  - [ ]* 3.6 Write property test for independent tenant branding
...
- [ ] 5. Implement the Security Layer
  - [ ] 5.1 Implement authorization guards (nonce, capability, REST token)
  ...
  - [ ]* 5.2 Write property test for authorization guards
  ...
  - [ ] 5.5 Implement input validation (type and length schemas)
  ...
  - [ ]* 5.6 Write property test for schema-violation rejection
  ...
  - [ ] 5.7 Implement the per-client rate limiter
...
- [ ] 6. Implement the Cache Manager
  - [ ] 6.1 Implement read-through caching with event invalidation
...
- [ ] 7. Implement inventory core services
  - [ ] 7.1 Implement `Inventory_Manager` CRUD and status transitions
  ...
  - [ ]* 7.2 Write property test for inventory CRUD and status round-trip
  ...
  - [ ] 7.3 Implement `Filter_Engine` (conjunctive apply, clear-all, count)
  ...
  - [ ]* 7.4 Write property test for conjunctive filtering
  ...
  - [ ]* 7.5 Write property test for clear-all restoring the full set
  ...
  - [ ]* 7.6 Write property test for match count equals result size
  ...
  - [ ] 7.7 Implement `Smart_Search_Engine` NL parser and search
  ...
  - [ ]* 7.8 Write property test for NL search parse-then-filter
  ...
  - [ ] 7.9 Implement the statistics aggregator
  ...
  - [ ]* 7.10 Write property test for quick-statistics aggregates
  ...
  - [ ] 7.11 Implement the pagination service
  ...
  - [ ]* 7.12 Write property test for pagination partitioning
  ...
  - [ ] 7.13 Implement `Expiry_Manager` (retention, expire, renew)
  ...
  - [ ]* 7.14 Write property test for age-based expiry
  ...
  - [ ]* 7.15 Write property test for renewal restoring status
...
- [ ] 8. Checkpoint - inventory core
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Implement view-formatting services
  - [ ] 9.1 Implement featured-carousel selection
    - Return exactly the units flagged featured (with image, price, area, CTA data); return empty when none are flagged
    - _Requirements: 6.1, 6.5_

  - [ ]* 9.2 Write property test for featured-carousel selection
  ...
  - [ ] 9.5 Implement broker-sheet formatter (shorthand + multi-variant)
  ...
  - [ ]* 9.6 Write property test for broker-sheet shorthand and variants
  ...
  - [ ] 9.11 Implement contact-link builder
  ...
  - [ ]* 9.12 Write property test for contact links
...
- [ ] 10. Implement lead and analytics services
  - [ ] 10.1 Implement `Lead_Capture` validation and persistence
  ...
  - [ ]* 10.2 Write property test for lead submission (valid and invalid)
  ...
  - [ ]* 10.5 Write property test for per-column lead counts
  ...
  - [ ] 10.6 Implement `Analytics_Engine` event recording and rankings
  ...
  - [ ]* 10.7 Write property test for engagement events and rankings
  ...
  - [ ] 10.8 Implement the dashboard metrics calculator
  ...
  - [ ]* 10.9 Write property test for dashboard metrics
...
- [ ] 11. Checkpoint - lead & analytics
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 12. Implement media, AI, and export services
  - [ ] 12.1 Implement `Media_Gallery_Manager` upload pipeline
  ...
  - [ ]* 12.2 Write property test for media upload validation
  ...
  - [ ] 12.3 Implement `AI_Content_Generator` and `AI_Tag_Generator`
  ...
  - [ ]* 12.4 Write property test for vocabulary-bounded AI tags
  ...
  - [ ] 12.5 Implement `Export_Engine` (PDF and Excel)
  ...
  - [ ]* 12.6 Write property test for export result-set fidelity
...
- [ ] 13. Implement premium-feature services
  - [ ] 13.1 Implement `Comparison_Engine` (cap of 4)
  ...
  - [ ] 13.2 Implement `Bookmark_Manager` and `Recently_Viewed_Tracker`
  ...
  - [ ] 13.3 Implement `Share_Manager` and `QR_Code_Generator`
  ...
  - [ ]* 13.4 Write property test for share links and QR codes
  ...
  - [ ] 13.5 Implement `SEO_Engine` (slugs, metadata, JSON-LD, sitemap)
  ...
  - [ ]* 13.6 Write property test for SEO slug safety, uniqueness, and resolution
  ...
  - [ ]* 13.7 Write property test for data-derived SEO metadata
  ...
  - [ ]* 13.8 Write property test for project structured data
  ...
  - [ ]* 13.9 Write property test for sitemap URL set
  ...
  - [ ] 13.10 Implement `Notification_Service` push delivery
  ...
  - [ ]* 13.11 Write property test for push delivery conditions
  ...
  - [ ] 13.12 Implement `CRM_Integration_Service` (config, forward, retry, encryption)
  ...
  - [ ]* 13.13 Write property test for CRM forwarding conditions
  ...
  - [ ]* 13.14 Write property test for CRM credential encryption
...
- [ ] 15. Implement controllers (REST and AJAX)
  - [ ] 15.1 Implement REST controllers under `rims/v1`
  ...
  - [ ] 15.3 Wire Security_Layer guards into all controllers
...
- [ ] 16. Implement theme integration and frontend rendering
  - [ ] 16.1 Implement `Theme_Integration_Engine`
  ...
  - [ ] 16.2 Implement `Frontend_Renderer` hero section
  ...
  - [ ] 16.3 Implement animated quick-statistics cards
  ...
  - [ ] 16.4 Implement the featured-inventory carousel UI
  ...
  - [ ] 16.5 Implement `Card_View` glassmorphism cards
  ...
  - [ ]* 16.6 Write property test for CSS/JS prefix scoping
  ...
  - [ ] 16.7 Implement dark/light mode, skeletons, infinite scroll, and lazy-load
  ...
  - [ ]* 16.8 Write frontend property test for view/color mode persistence
  ...
  - [ ] 16.9 Implement the `View_Manager` Alpine state module
  ...
  - [ ]* 16.10 Write frontend property test for view-switch state preservation
...
- [ ] 17. Implement view-mode UIs and the project detail page
  - [ ] 17.1 Implement `Table_View` UI
  ...
  - [ ] 17.2 Implement `Broker_Sheet_View` UI
  ...
  - [ ] 17.4 Implement the `Project_Detail_Page`
  ...
  - [ ] 17.5 Implement the advanced filter UI
  ...
  - [ ] 17.6 Implement the smart-search UI
  ...
  - [ ] 17.7 Implement the lead-capture UI
  ...
  - [ ] 17.8 Implement bookmarks, comparison, recently-viewed, and share UI
  ...
  - [ ]* 17.9 Write frontend property test for comparison-set cap
  ...
  - [ ]* 17.10 Write frontend property test for recently-viewed ordering
...
- [ ] 18. Checkpoint - frontend
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 19. Implement shortcodes and Elementor widgets
  - [ ] 19.1 Implement `Shortcode_Registrar`
  ...
  - [ ] 19.2 Implement `Elementor_Widget_Provider`
...
- [ ] 20. Implement admin screens
  - [ ] 20.1 Implement the `Admin_Dashboard` screen
  ...
  - [ ] 20.4 Implement the lead Kanban board UI
...
- [ ] 21. Implement integrations, PWA, and scheduled jobs
  ...
  - [ ] 21.4 Implement the expiry cron job and broker notification
    - Schedule a recurring job that expires aged units and notifies the owning Broker_Agent
    - _Requirements: 29.2, 29.3_

  - [ ] 21.5 Wire CRM forward-on-persist with retry and logging
  ...
  - [ ] 21.6 Wire QR-code endpoints and share output
    - Expose QR generation for units/projects and render share actions resolving to public URLs
    - _Requirements: 27.2, 27.3, 27.4_

- [ ] 22. Final wiring and integration tests
  - [ ] 22.1 Wire all entry points in the bootstrap
  ...
  - [ ]* 22.2 Write integration and smoke tests for external wiring
